...
////        CYLTabBarController *tt = [CYLTabBarController tabBarControllerWithViewControllers:self.view tabBarItemsAttributes:<#(NSArray<NSDictionary *> *)#>]
...
- (NSArray *)viewControllers {
    ...
    ThreeViewController *thirdViewController = [[ThreeViewController alloc] init];
    UIViewController *thirdNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    FourViewController *fourthViewController = [[FourViewController alloc] init];
